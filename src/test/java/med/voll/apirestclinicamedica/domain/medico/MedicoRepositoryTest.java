...
import med.voll.apirestclinicamedica.domain.consulta.Consulta;
import med.voll.apirestclinicamedica.domain.endereco.DadosEndereco;
import med.voll.apirestclinicamedica.domain.paciente.DadosCadastroPaciente;
...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioNaDataCenario02() {
        // given ou arrange
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);
